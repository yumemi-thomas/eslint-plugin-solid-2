...
ruleTester.run("no-unknown-namespaces", rule as never, {
  valid: [
  ...
  invalid: [
    ...
    {
      code: `let el = <div use:tooltip={opts} />`,
      errors: [{ messageId: "removed" }],
    },
    {
      code: `let el = <div use:tooltip />`,
      errors: [{ messageId: "removed" }],
    },
    {
    ...
    {
      code: `let el = <div bool:checked />`,
      errors: [{ messageId: "removed" }],
    },
    {
      code: `let el = <div oncapture:click={null} />`,
      errors: [{ messageId: "removed" }],
    },
    {
    ...
    {
      code: `let el = <Box use:tooltip={opts} />`,
      errors: [
        {
          messageId: "component",
          suggestions: [
            {
              messageId: "componentSuggest",
              data: { namespace: "use", name: "tooltip" },
              output: `let el = <Box tooltip={opts} />`,
            },
          ],
        },
      ],
